...
<form id="avatar_form" enctype="multipart/form-data" method="post" action="parsers/photo_system.php">
    ...
    if ($log_avatar1 == NULL) {
        $profile_pic = '<img src="/images/defaultavatar-'.strtolower($log_gender).'.jpg" alt="'.$log_firstname." ".$log_lastname.'">';
    } else {
                ...
                <div id="myinfoform" class="myinfoform white_box">
                    <div style='width:inherit'>
                        ...
                        <div class="option_btns">
                            <button id="savechanges_btn1" class="savechanges_btn myinfo_btn" onclick="change_info()">Save</button>
                        ...
                        <div class="option_btns">
                            <button id="savechanges_btn2" class="savechanges_btn myinfo_btn" onclick="change_info()">Save</button>
