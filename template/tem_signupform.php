<form name="signupform" id="signupform" class="signupform" onsubmit="return false;">
    ...
    <div id="pass1status" class="passstatus reg_status"></div>
    ...
    <div id="pass2status" class="passstatus reg_status"></div>
    ...
    <div class="viewTerms">
        By clicking Sign Up, you agree to our <a href="<?php echo $url; ?>terms.php" target="_blank">Terms</a>, <a href="#" target="_blank" onclick="">Data Use Policy</a> <br />
