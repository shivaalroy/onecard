...
<div id="loggedin_menubar_container" class="loggedin_menubar_container">
    <div id="loggedin_menubar" class="loggedin_menubar">
        <div id="loggedin_menubar_left" class="loggedin_menubar_left">
            <a href="<?php echo $url; ?>" class="home_link">
                <img class="home_img" src="<?php echo $url; ?>img/logo_loggedin.png" alt="logo" title="OneCard">
            </a>
            <form name="menubar_search" id="menubar_search" class="menubar_search" onsubmit="return false;">
                ...
                <button id="menubar_search_btn" class="menubar_search_btn" onclick="menubar_user_search()">
                    <img class="search_magglass" src="<?php echo $url; ?>img/search_magglass.png" alt="Search">
                </button>
                <br />
        ...
        <div id="loggedin_menubar_right" class="loggedin_menubar_right">
            ...
            <ul class="navigation_list">
                <li class="menu_item">
                    <a id="log_firstname" class="menubar_container menubar_link" href="<?php echo $url; ?>myinfo.php">
                ...
                <li class="menu_item">
                    <div id="contact_reqs_container" class="popup_badge_container menubar_container no_bg">
                        <a id="contact_reqs_link" class="contact_reqs_link menubar_link" href="<?php echo $url; ?>contact_requests.php" <?php echo $cr_icon_style; ?>></a>
                        <a id="cr_badge_link" class="popup_badge_link" href="<?php echo $url; ?>contact_requests.php">
                ...
                <li class="menu_item">
                    <div id="notifications_container" class="popup_badge_container menubar_container">
                        <a id="notifications_link" class="notifications_link menubar_link" href="<?php echo $url; ?>notifications.php">Notifications</a>
                        <a id="notes_badge_link" class="popup_badge_link" href="<?php echo $url; ?>notifications.php"><div id="notes_badge" class="popup_badge" <?php echo $notes_badge_style; ?>>
                ...
                <div id="more_options" class="more_options non_container" onclick="toggle_more_options()" onmouseover="moreoptionsOver()" onmouseout="moreoptionsOut()">
                    ...
                    <ul id="more_options_submenu" class="more_options_submenu" onmouseover="moreoptionsOver()" onmouseout="moreoptionsOut()">
                        <li onclick="location.href='<?php echo $url; ?>user_includes/download_contacts.php'">
                            <div class="list_text">Download Contacts</div>
                        </li>
                        <li>
                            <a class="list_text" href="<?php echo $url; ?>settings.php">Settings &amp; Preferences</a>
                        </li>
                        <li onclick="location.href='<?php echo $url; ?>logout.php'">
